...
mod tests {
    ...
    /// TODO: CHECK VALUES FOR KICKER_SPLIT EQUALS FALSE, ONLY WHEN `extract_kicker` HAS BEEN IMPLEMENTED
    /// FOR KICKER_SPLIT EQUALS FALSE, winning_hands.len() == 1. USE TWO HANDS OF THE SAME RANK
    /// 
