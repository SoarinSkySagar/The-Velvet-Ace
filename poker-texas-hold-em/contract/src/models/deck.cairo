...
mod tests {
    ...
    fn count_unique_cards(deck: @Deck) -> u32 {
        ...
        while i < cards_len {
            ...
            let key = (card.suit.into() * 100 + card.value.into()).into();
    ...
    fn test_new_deck() {
        ...
        let unique_count = count_unique_cards(@deck);
        ...
        while i < deck.cards.len() {
            let card = *deck.cards.at(i);
            let suit_key = card.suit.into();
            let value_key = (card.value - 1).into();
    ...
    fn test_new_deck_edge_cases() {
        ...
        let mut deck1 = Deck { id: 1, cards: array![] };
        let mut deck2 = Deck { id: 42, cards: array![] };
    ...
    fn test_multiple_decks() {
        let mut deck1 = Deck { id: 1, cards: array![] };
        let mut deck2 = Deck { id: 2, cards: array![] };

        deck1 = deck1.new_deck();
        deck2 = deck2.new_deck();

        // Deal from deck1 and verify deck2 is unchanged
        let initial_deck2_count = deck2.cards.len();
        ...
        let initial_deck1_count = deck1.cards.len();
