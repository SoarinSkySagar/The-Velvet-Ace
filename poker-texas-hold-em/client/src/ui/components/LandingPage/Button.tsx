...
const Button = ({
  ...
  const variantClasses = {
    'gradient': 'bg-gradient-to-r from-[#B31926] to-[#4D0B10] text-white border-3 border-[#FFD700]',
    ...
    'outline-green': 'bg-transparent text-white border-3 border-[#00CF00] hover:bg-[#00CF00]',
